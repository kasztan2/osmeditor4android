...
public class WaySelectionActionModeCallback extends ElementSelectionActionModeCallback {
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        ...
        menu.add(Menu.NONE, MENUITEM_START_END_OF_WAY, Menu.NONE, R.string.menu_start_end_way).setIcon(ThemeUtils.getResIdFromAttribute(main, R.attr.menu_start_end_way));
